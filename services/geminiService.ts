...
// fix: Adhere to Gemini API guidelines by using process.env.API_KEY directly for initialization and remove manual API key handling. This also resolves the TypeScript error on `import.meta.env`.
