...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    originalPrice: 69.99,
    rating: 4.8,
    imageUrl: 'https://picsum.photos/seed/wallet/800/800',
    categories: ['men'],
  },
  {
    id: 8,
    name: 'Aviator Sunglasses',
    description: 'Iconic aviator sunglasses with polarized lenses for UV protection.',
    price: 89.99,
    rating: 4.7,
    imageUrl: 'https://picsum.photos/seed/sunglasses/800/800',
    categories: ['women', 'men'],
  },
  {
    id: 9,
    name: 'Classic Men\'s Suit',
    description: 'A tailored two-piece suit for formal occasions. Look sharp and sophisticated.',
    price: 450.00,
    originalPrice: 599.99,
    rating: 4.9,
    imageUrl: 'https://picsum.photos/seed/suit/800/800',
    categories: ['men'],
  },
  {
    id: 10,
    name: 'Graphic Tee',
    description: 'Unisex graphic t-shirt with a unique, artistic print.',
    price: 34.99,
    rating: 4.3,
    imageUrl: 'https://picsum.photos/seed/graphictee/800/800',
    categories: ['men', 'women', 't-shirts'],
  },
  {
    id: 11,
    name: 'Suede Ankle Boots',
    description: 'Stylish and versatile ankle boots perfect for any season.',
    price: 149.99,
    originalPrice: 179.99,
    rating: 4.6,
    imageUrl: 'https://picsum.photos/seed/boots/800/800',
    categories: ['women', 'shoes'],
  },
  {
    id: 12,
    name: 'Silver Bracelet',
    description: 'A delicate sterling silver bracelet, perfect for layering.',
    price: 79.99,
    rating: 4.9,
    imageUrl: 'https://picsum.photos/seed/bracelet/800/800',
    categories: ['women', 'jewelry'],
  }
];
